...
exports.PinPadService = exports.pinPadService = void 0;
class PinPadService {
    constructor(config) {
        this.token = null;
    ...
    async login() {
        ...
        try {
            ...
            const response = await this.request('/API_PPAD/login', {
                method: 'POST',
    ...
    async testConnection() {
        try {
            ...
            const response = await this.request('/API_PPAD/test', {
                method: 'POST',
            });
    ...
    async processTransaction(request) {
        try {
            ...
            const response = await this.request('/API_PPAD/procesarTransaccion', {
                method: 'POST',
     ...
     */
    async processSale(amountCents, currencyCode = '604', enableQR = true) {
        const request = {
            ecr_aplicacion: 'POS',
            ecr_transaccion: '01',
     ...
     */
    async processSaleCardOnly(amountCents, currencyCode = '604') {
     ...
     */
    async processSaleWithQR(amountCents, currencyCode = '604') {
     ...
     */
    async processSaleQRDirect(amountCents, currencyCode = '604') {
        return this.processTransaction({
            ecr_aplicacion: 'POS',
            ecr_transaccion: '67',
            ecr_amount: amountCents.toString(),
     ...
     */
    async voidSale(referenceNumber) {
        return this.processTransaction({
            ecr_aplicacion: 'POS',
            ecr_transaccion: '06',
     ...
     */
    async reprintBatch(batchNumber) {
        return this.processTransaction({
            ecr_aplicacion: 'POS',
            ecr_transaccion: '28',
...
// Singleton instance
exports.pinPadService = new PinPadService();
